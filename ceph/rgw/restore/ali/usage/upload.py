...
filename = 'qjrknevnizfkywugfbkoopthikzcptuh.txt'
...
oss2.resumable_upload(bucket, 'remote-multipart.txt', filename, multipart_threshold=100 * 1024, part_size=100*1024)
sys.exit()
